    ...
    public partial class MainForm : Form
    {
        ...
        private void CheckForUpdate()
        {
            ...
            _ = this.Invoke(new MethodInvoker(async delegate ()
            {
                ...
                try
                {
                    string jsonContent = await httpClient.GetStringAsync("https://nguyennhatit.github.io/QADRPC/fetchVersion.json");
                    ...
                    if (versionInfo != null)
                    {
                        if (string.Compare(CurrentVersion, versionInfo.LatestVersion) < 0)
                        {
                            ...
                            {
                                DialogResult result = MessageBox.Show($"A newer version ({versionInfo.LatestVersion}) is available for download. Do you want to go to browser and download it?", "QADRPC Update Available", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
                            ...
                            if (QADRPCNotifyIcon.Visible == true)
                            {
                                QADRPCNotifyIcon.BalloonTipIcon = ToolTipIcon.Info;
                                QADRPCNotifyIcon.BalloonTipText = $"A newer version ({versionInfo.LatestVersion}) is available for download. Click this notification to download now!";
                                QADRPCNotifyIcon.BalloonTipTitle = "An update of TinyRDPC is available to download";
                                QADRPCNotifyIcon.BalloonTipClicked += (object sender, EventArgs e) =>
                                {
                                    DialogResult result = MessageBox.Show($"A newer version ({versionInfo.LatestVersion}) is available for download. Do you want to go to browser and download it?", "QADRPC Update Available", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
                                    if (result == DialogResult.Yes)
                                    {
                                ...
                                QADRPCNotifyIcon.ShowBalloonTip(5000);
                            }
                        }
                    }
                }
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            QADRPC.Utils.Configuration config = configManager.LoadConfiguration();
            ...
            versionLabel.Text = $"Version: {CurrentVersion} - powered by Nguyen Minh Nhat";
        ...
        private void runOnStartup_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (runOnStartup.Checked)
                rk.SetValue("QADRPC", Application.ExecutablePath);
            else
                rk.DeleteValue("QADRPC", false);
        ...
        private void updateStatus()
        {
            ...
            {
                Details = topText.Text ?? "Please provide top text (QADRPC)",
                State = secondText.Text ?? "Please provide bottom text (QADRPC)",
        ...
        {
            _ = new OpenBrowser("https://github.com/nguyennhatit/QADRPC");
        }
        ...
        private void MainFormOnResize(object sender, EventArgs e)
        {
            if (WindowState == FormWindowState.Minimized)
            {
                ...
                {
                    QADRPCNotifyIcon.BalloonTipIcon = ToolTipIcon.Info;
                    QADRPCNotifyIcon.BalloonTipText = "QADRPC is minimized in the system tray; to open the main window, double-click on this icon; you only see this tip once. Enjoy!";
                    QADRPCNotifyIcon.BalloonTipTitle = "QADRPC is now minimized at system tray";
                    QADRPCNotifyIcon.ShowBalloonTip(5000);
        ...
        private void TrayIconOnClick(object sender, MouseEventArgs e)
        {
            ...
            QADRPCNotifyIcon.Visible = false;
        }
        ...
        {
            new OpenBrowser("https://github.com/nguyennhatit/QADRPC/tree/master?tab=readme-ov-file#how-to-get-discord-app-id");
        }

        private void linkLabel3_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            new OpenBrowser("https://github.com/nguyennhatit/QADRPC/tree/master?tab=readme-ov-file#how-to-get-image-key");
        }
