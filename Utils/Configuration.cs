...
namespace QADRPC.Utils
{
    ...
    {
        private static readonly string ConfigPathName = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "QADRPC");
        private static readonly string ConfigFileName = Path.Combine(ConfigPathName, "QADRPC.ini");
        ...
        private Configuration CreateDefaultConfiguration()
        {
            Configuration config = new Configuration
            {
                topText = "Using QADRPC",
                bottomText = "powered by Nguyen Minh Nhat",
                discordAppId = "1429569020507459784",
                button1Label = "GitHub",
                button2Label = "",
                button1Url = "https://github.com/nguyennhatit/QADRPC",
                button2Url = "",
                largeImageKey = "512x512",
                largeImageText = "512x512",
                smallImageKey = "",
                enableButton1 = true,
                enableButton2 = false,
                runOnStartup = false,
